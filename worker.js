...
function buildStaticInstructions() {
  return [
    ...
    'BELANGRIJK — de loutere vaststelling dat een concurrent deze categorie vandaag levert, zonder uitgesproken bezwaar tegen Winsol, is "neutral" (de tag "concurrentie" legt dat feit al vast). Geeft de klant er wél een reden of bezwaar bij (prijs, service, voorwaarden, acties, vertrouwen), dan is het "negative".',
